namespace School_Report
{
    partial class frmSubject
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.SubjectScheduleBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.subjectScheduleBindingSource1 = new System.Windows.Forms.BindingSource(this.components);
            this.subjectScheduleTableAdapter = new School_Report.HOMEWORKDataSetTableAdapters.SubjectScheduleTableAdapter();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.SubjectScheduleBindingSource)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.subjectScheduleBindingSource1)).BeginInit();
            this.SuspendLayout();
            // 
            // booksBindingSource1
            // 
            ...
            reportDataSource1.Name = "DataSet_Subject";
            reportDataSource1.Value = this.subjectScheduleBindingSource1;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "School_Report.Report_Subject.rdlc";
            ...
            // 
            // SubjectScheduleBindingSource
            // 
            this.SubjectScheduleBindingSource.DataMember = "SubjectSchedule";
            this.SubjectScheduleBindingSource.DataSource = this.hOMEWORKDataSet;
            // 
            // subjectScheduleBindingSource1
            // 
            this.subjectScheduleBindingSource1.DataMember = "SubjectSchedule";
            this.subjectScheduleBindingSource1.DataSource = this.hOMEWORKDataSet;
            // 
            // subjectScheduleTableAdapter
            // 
            this.subjectScheduleTableAdapter.ClearBeforeFill = true;
            // 
            // frmSubject
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.SubjectScheduleBindingSource)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.subjectScheduleBindingSource1)).EndInit();
        ...
        private System.Windows.Forms.BindingSource SubjectScheduleBindingSource;
        private System.Windows.Forms.BindingSource subjectScheduleBindingSource1;
        private HOMEWORKDataSetTableAdapters.SubjectScheduleTableAdapter subjectScheduleTableAdapter;
    }
}

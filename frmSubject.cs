...
namespace School_Report
{
    public partial class frmSubject : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'hOMEWORKDataSet.SubjectSchedule' table. You can move, or remove it, as needed.
            this.subjectScheduleTableAdapter.Fill(this.hOMEWORKDataSet.SubjectSchedule);

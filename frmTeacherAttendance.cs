...
namespace School_Report
{
    public partial class frmTeacherAttendance : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'hOMEWORKDataSet.TeacherTotalHoursView' table. You can move, or remove it, as needed.
            this.teacherTotalHoursViewTableAdapter.Fill(this.hOMEWORKDataSet.TeacherTotalHoursView);
